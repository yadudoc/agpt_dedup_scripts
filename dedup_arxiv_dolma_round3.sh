...
datasources=(
    /lus/eagle/projects/argonne_tpc/TextCollections/Arxiv_Dolma_v1.7/    
)

minhashdir=/lus/eagle/projects/argonne_tpc/yadunand/index_individual_round_3/Arxiv_Dolma_v1.7/minhashes/

OUTPUT_DIR=/lus/eagle/projects/argonne_tpc/yadunand/index_individual_round_3_peS2o
