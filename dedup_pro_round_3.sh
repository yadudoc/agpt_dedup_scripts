...
#PBS -o /eagle/argonne_tpc/yadunand/pro_index.submit.stdout
#PBS -e /eagle/argonne_tpc/yadunand/pro_index.submit.stderr
...
minhashdir=/lus/eagle/projects/argonne_tpc/yadunand/index_individual_round_3/Pro/minhashes
